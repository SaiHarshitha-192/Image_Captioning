...
Original file is located at
    https://colab.research.google.com/drive/1WbdWi8z5nEC6iiN_cKtd53J_Vdcw4hGB
"""
...
with open(os.path.join(WORKING_DIR, 'features.pkl'), 'rb') as f:
    ...
    print(features.keys())
    a=features['1000268201_693b08cb0e']
    print(a.shape)
...
#model.load_weights('best_weights7.h5')
for i in range(epochs):
    # create data generator
    generator = data_generator(train, mapping, features, tokenizer, max_length, vocab_size, batch_size)
    # fit for one epoch
    model.fit(generator, epochs=1, steps_per_epoch=steps, verbose=1)
model.save_weights('best_weights8.h5')
...
model.save(WORKING_DIR+'/best_model_final.h5')

new_model = load_model(WORKING_DIR+'/best_model_final.h5')
new_model.summary()
...
generate_caption('/content/1329832826_432538d331.jpg')
...
image_path = '/content/1370615506_2b96105ca3.jpg'
# load image
